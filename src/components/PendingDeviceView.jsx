...
const PendingDeviceView = () => {
  ...
  return (
    <div
      ...
      style={{ minHeight: '100vh', backgroundColor: 'var(--cream)', padding: '2rem' }}
    >
      <div
        className="card text-center"
        style={{ maxWidth: 480, width: '100%', padding: '3rem 2rem' }}
      >
        ...
        <div className="mb-6 p-4 rounded bg-white text-left shadow-sm border">
          ...
          <div className="flex-between align-center">
            <code className="text-lg" style={{ color: 'var(--accent)' }}>
