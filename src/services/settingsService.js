...
export const fetchSettings = async () => {
  ...
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "fetchSettings" });
    throw error;
  }
  return data;
};
...
export const fetchStoreHours = async () => {
  ...
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "fetchStoreHours" });
    throw error;
  }
  return data;
};
...
export const fetchStoreClosures = async () => {
  ...
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "fetchStoreClosures" });
    throw error;
  }
  return data;
};
...
export const upsertStoreHour = async (payload) => {
  ...
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "upsertStoreHour" });
    throw error;
  }
};
...
export const insertStoreClosure = async (payload) => {
  const { data, error } = await supabase
    ...
    .single();
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "insertStoreClosure" });
    throw error;
  }
  return data;
};
...
export const upsertSettings = async (payload) => {
  ...
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "upsertSettings" });
    throw error;
  }
};
...
export const requestPasswordReset = async (email, redirectTo) => {
  ...
  if (error) {
    errorReporting.capture(error, { domain: "settings", operation: "requestPasswordReset" });
    throw error;
  }
};
