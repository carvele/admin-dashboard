...
export const AuthProvider = ({ children }) => {
    ...
    const handleDeviceCheck = async (firebaseUser) => {
        ...
        try {
            ...
            registerDevice(visitorId, navigator.userAgent, firebaseUser.email, firebaseUser.displayName || '').catch((err) => console.warn('[Device] Registration write failed:', err));
            ...
            try {
                ...
                else if (firebaseUser.email === 'admin@jezsy.com' ||
                ...
                if (firebaseUser.email === 'admin@jezsy.com' ||
                    firebaseUser.email === 'admin@jezsycollection.com') {
                    resolvedRole = 'Owner';
                }
                else {
    ...
    const logout = async () => {
        ...
        if (savedFingerprint)
            localStorage.setItem('_jz_fp_id', savedFingerprint);
    ...
    if (isLoading) {
        return (_jsx("div", { style: {
            ...
            }, children: _jsx("div", { className: "loading-spinner" }) }));
    }
