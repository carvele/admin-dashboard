...
const PRODUCTS = [
  ...
  },
  {
    ...
    fabric: 'Poly Mesh with Sequins',
    tags: ['party', 'nightout', 'sparkle'],
    restock_date: null,
    color: 'Gold',
    fitAndSizing: 'Slim Fit',
    season: 'All-Season',
  ...
  },
  {
    ...
    tags: ['vacation', 'resort', 'maxi'],
    restock_date: '2026-11-15T00:00:00.000Z',
    color: 'Coral',
  ...
  },
  {
    ...
    tags: ['business', 'casual', 'essential'],
    restock_date: null,
    color: 'Charcoal',
    fitAndSizing: 'Regular Fit',
    season: 'All-Season',
  ...
  },
  {
    ...
    price: 11000,
    material: 'Satin',
    fabric: 'Stretch Silk Satin',
    tags: ['party', 'cocktail', 'mini'],
    restock_date: '2026-10-31T00:00:00.000Z',
    color: 'Burgundy',
    fitAndSizing: 'Slim Fit',
    season: 'Winter',
    occasion: 'Party',
...
export const seedDemoData = async (onProgress) => {
  ...
  for (let i = 0; i < PRODUCTS.length; i++) {
    ...
    const docId = await addDocument('products', {
      ...
      isFeatured: featured,
      tags: [...(p.tags || []), featured ? 'Featured' : null, 'New Arrival'].filter(Boolean),
      imageUrl: '👗',
      images: [],
