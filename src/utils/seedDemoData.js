...
// --- Data Templates ---
const CUSTOMERS = [
  { name: 'Maria Santos', email: 'maria.santos@email.com', status: 'Active', phone: '+63 917 123 4567', totalSpent: 45000, wardrobeItems: 3, reservations: 5 },
  { name: 'Anna Cruz', email: 'anna.cruz@email.com', status: 'VIP', phone: '+63 918 234 5678', totalSpent: 120000, wardrobeItems: 8, reservations: 12 },
  { name: 'Bea Reyes', email: 'bea.reyes@email.com', status: 'Active', phone: '+63 919 345 6789', totalSpent: 32000, wardrobeItems: 2, reservations: 4 },
  { name: 'Carlos Tan', email: 'carlos.tan@email.com', status: 'Inactive', phone: '+63 920 456 7890', totalSpent: 8000, wardrobeItems: 1, reservations: 1 },
  { name: 'Diana Lim', email: 'diana.lim@email.com', status: 'Active', phone: '+63 921 567 8901', totalSpent: 67000, wardrobeItems: 5, reservations: 7 },
];

const PRODUCTS = [
  { name: 'Midnight Elegance Gown', category: 'Dresses', price: 15000, material: 'Silk', color: 'Black', fitAndSizing: 'Slim Fit', season: 'All-Season', occasion: 'Formal', sizes: ['S', 'M', 'L'], visibility: 'Published', featured: true },
  { name: 'Summer Breeze Set', category: 'Tops', price: 4500, material: 'Linen', color: 'White', fitAndSizing: 'Regular Fit', season: 'Summer', occasion: 'Casual', sizes: ['XS', 'S', 'M', 'L', 'XL'], visibility: 'Published', featured: false },
  { name: 'Royal Wedding Gown', category: 'Dresses', price: 35000, material: 'Tulle & Lace', color: 'Ivory', fitAndSizing: 'True to Size', season: 'All-Season', occasion: 'Wedding', sizes: ['S', 'M', 'L'], visibility: 'Published', featured: true },
  { name: 'Business Elite Blazer', category: 'Outerwear', price: 8500, material: 'Wool Blend', color: 'Navy', fitAndSizing: 'Regular Fit', season: 'Autumn', occasion: 'Business', sizes: ['S', 'M', 'L', 'XL'], visibility: 'Published', featured: false },
  { name: 'Party Night Sequin Top', category: 'Tops', price: 6200, material: 'Sequin Mesh', color: 'Gold', fitAndSizing: 'Slim Fit', season: 'All-Season', occasion: 'Party', sizes: ['XS', 'S', 'M'], visibility: 'Published', featured: true },
  { name: 'Resort Maxi Dress', category: 'Dresses', price: 9800, material: 'Chiffon', color: 'Coral', fitAndSizing: 'Oversized', season: 'Summer', occasion: 'Resort', sizes: ['S', 'M', 'L', 'XL'], visibility: 'Published', featured: false },
  { name: 'Classic Tailored Pants', category: 'Bottoms', price: 5500, material: 'Cotton Twill', color: 'Charcoal', fitAndSizing: 'Regular Fit', season: 'All-Season', occasion: 'Business', sizes: ['S', 'M', 'L', 'XL', '2XL'], visibility: 'Published', featured: false },
  { name: 'Cocktail Mini Dress', category: 'Dresses', price: 11000, material: 'Satin', color: 'Burgundy', fitAndSizing: 'Slim Fit', season: 'Winter', occasion: 'Party', sizes: ['XS', 'S', 'M', 'L'], visibility: 'Draft', featured: false },
];
...
export const seedDemoData = async (onProgress) => {
  ...
  for (let i = 0; i < PRODUCTS.length; i++) {
    const p = PRODUCTS[i];
    const acronym = p.name.split(' ').map(w => w[0]).join('').substring(0, 3).toUpperCase();
  ...
  for (let i = 0; i < 15; i++) {
    ...
    await addDocument('messages', {
      ...
      time: new Date(Date.now() - (15 - i) * 3600000).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    });
  }
